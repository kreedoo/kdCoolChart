;(function(){
    $(function(){
        ...
        $('#cool-chart-rect-1').kdCoolChart({
            ...
            datas: [
                {
                    value: ['0.56','0.57','0.59','0.61','0.64','0.66','0.69','0.70','0.74','0.77','0.79'],
                    color: '#4082E8'
                },
                {
                    value: ['0.44','0.43','0.41','0.39','0.36','0.34','0.31','0.30','0.26','0.23','0.21'],
                    color: '#FFD400'
                },
                {
                    value: ['0.98','0.95','0.92','0.88','0.82','0.74','0.66','0.55','0.42','0.25','0.03'],
                    color: '#f00'
                }
                /*['0.56','0.44','0.98'],
                ['0.57','0.43','0.95'],
            ...
            horizontalLabels: function(){
                return this.horizontalAllLabels;
            }
        });
    });
}());